  ...
  return (
    <div className='shadow-xl w-60 h-20 pt-1 border-b-2 border-b-blue-300'>
        ...
        <div className='flex justify-center mt-3'>
            ...
            <a className='ml-2 font-bold text-sm text-blue-500 border-blue-300 border-b-2' translate='no' href="https://github.com/John-devX" target='_blank' rel='noreferrer' >GitHub</a>
        </div>
    </div>
  )
}
